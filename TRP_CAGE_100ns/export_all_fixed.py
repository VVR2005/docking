...
with PdfPages(pdf_path) as pdf:
    ...
    ax.text(0.5,0.15,'11 analyses: RMSD, RMSF, Rg, DSSP, Trp6-Pro, Native contacts, PCA, Clustering, H-bonds, SASA, FEL',fontsize=10,ha='center',va='top',color='#888')
    ...
    a2.set(xlabel='PC1',ylabel='PC2',title='PCA (native contacts)')
